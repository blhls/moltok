/* ============================================================
   ...
   All static content. Tweak freely; UI updates on reload.
   ============================================================ */
...
const emails = [
  ...
  },
  {
    ...
    from: "The Hand", subject: "Limited time: SHELL PREMIUM™", date: "2026-04-12",
  ...
  /* ─── INBOX / PATRIARCHY ─────────────────────────────────── */
  {
    ...
    from: "Father Figure", subject: "Re: your recent behaviour", date: "2026-03-08",
  ...
  /* ─── INBOX / IMPERIALISM ─────────────────────────────────── */
  {
    ...
    from: "Map Drawer", subject: "Border adjustment notice", date: "2026-03-15",
  ...
  /* ─── INBOX / NOTES ──────────────────────────────────────── */
  {
    ...
    from: "Self", subject: "fragment 17", date: "2026-04-02",
  ...
  },
  {
    ...
    from: "Self", subject: "the cartographer god — bothering me again", date: "2026-04-08",
  ...
  /* ─── SENT ──────────────────────────────────────────────── */
  {
    ...
    from: "You", subject: "Re: your recent behaviour", date: "2026-03-09",
  ...
  /* ─── DRAFTS ────────────────────────────────────────────── */
  {
    ...
    from: "You (draft)", subject: "Manifesto §3 — the neo-gladiator", date: "2026-04-22",
    tags: ["draft", "bia"], type: "text",
    body: "draft fragment: the panopticon's purpose is to ensure docile behaviour by way of unverifiable surveillance. the neo-gladiator inverts it by inflicting non-sensical punishment upon themselves, making the gaze of the guards meaningless — and therefore reclaiming sovereignty over the dynamic. ..."
  },
  ...
  },
  {
    ...
    from: "La Main", subject: "Votre dette en chitine", date: "2026-03-12",
  ...
  },
  {
    ...
    from: "Figure Paternelle", subject: "Comme convenu dans mon précédent courriel...", date: "2026-03-19",
    tags: ["discipline"], type: "text",
  ...
  },
  {
    ...
    from: "Soi", subject: "fragment occitan", date: "2026-04-18",
  ...
  },
  {
    ...
    from: "Vous", subject: "Re: Comme convenu...", date: "2026-03-20",
    tags: ["réponse"], type: "text",
    body: "non."
  },
  {
    id: 107, lang: "fr", section: "drafts",
    from: "Vous (brouillon)", subject: "Manifeste §3 — le néo-gladiateur", date: "2026-04-24",
    tags: ["brouillon", "bia"], type: "text",
    body: "brouillon : le panoptique sert à garantir un comportement docile par la surveillance non-vérifiable. le néo-gladiateur l'inverse en s'infligeant une punition absurde, rendant le regard des gardiens sans objet — et reprenant ainsi la souveraineté sur la dynamique. ..."
  },
  {
