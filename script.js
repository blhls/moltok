/* ================================================================
MOULTLOOK — script.js v12.0
Icons replacing emojis. Claw cursor FX. Search results scaphander.
================================================================ */
'use strict';
...
function executeSearch() {
  ...
  if (!results.length) {
    html += `<p style="font-family:var(--font-mono);color:var(--text-dim);font-size:17px;">${nr}</p>`;
  } else {
